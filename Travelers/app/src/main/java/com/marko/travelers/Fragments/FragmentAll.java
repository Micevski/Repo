...
import com.marko.travelers.Activities.TravelAllActivity;
...
public class FragmentAll extends Fragment implements RecyclerViewAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.all_travels_fragment,container, false);

        RecyclerView recyclerView = v.findViewById(R.id.all_recyclerview);
        RecyclerViewAdapter viewAdapter = new RecyclerViewAdapter(getContext(), travelList);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(viewAdapter);
        viewAdapter.setOnItemClickListener(FragmentAll.this);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        travelList.add(new Travel(a,"Gevgelija","Probistip","28/8/2018","19:00","3", 200, "mkd"));
        travelList.add(new Travel(b,"Skopje","Ohrid","28/8/2018","19:00","3", 300, "mkd"));
        travelList.add(new Travel(a,"Skopje","Ohrid","28/8/2018","19:00","3", 300, "mkd"));
        travelList.add(new Travel(b,"Skopje","Ohrid","28/8/2018","19:00","3", 300, "mkd"));
        travelList.add(new Travel(a,"Skopje","Ohrid","28/8/2018","19:00","3", 300, "mkd"));
        travelList.add(new Travel(b,"Skopje","Ohrid","28/8/2018","19:00","3", 300, "mkd"));
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(getActivity(), TravelAllActivity.class);
